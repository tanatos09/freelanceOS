...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "unit: označuje jednotkové testy (modely, serializers)")
...
def project(db, user, client_obj):
    ...
    return ProjectFactory(user=user, client=client_obj, name="Test Project", status="active")
