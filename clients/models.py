...
class Client(models.Model):
    ...
    name = models.CharField(
        max_length=255,
        help_text='Název firmy nebo jméno osoby'
    )
    ...
    company = models.CharField(
        max_length=255,
        blank=True,
        help_text='Název společnosti (pokud se liší od name)'
    )
    
    # Metadata
    notes = models.TextField(
        blank=True,
        help_text='Interní poznámky (není vidět klientovi)'
    )
