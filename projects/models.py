...
class Project(models.Model):
    ...
    name = models.CharField(
        max_length=255,
        help_text='Název projektu'
    )
    description = models.TextField(
        blank=True,
        help_text='Podrobný popis projektu'
    )
    status = models.CharField(
        max_length=20,
        choices=STATUS_CHOICES,
        default='draft',
        help_text='Status projektu'
    )
    ...
    budget = models.DecimalField(
        ...
        decimal_places=2,
        default=0,
        help_text='Celkový rozpočet projektu'
    )
    estimated_hours = models.DecimalField(
        max_digits=8,
        decimal_places=2,
        default=0,
        help_text='Odhadnuté hodiny'
    )
    ...
    start_date = models.DateField(
        null=True,
        blank=True,
        help_text='Datum začátku projektu'
    )
    end_date = models.DateField(
        null=True,
        blank=True,
        help_text='Deadline projektu'
    )
