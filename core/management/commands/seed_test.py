...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS('✓ Uživatel vytvořen: test@example.com / test123')
        )
        ...
        self.stdout.write(
            self.style.SUCCESS(f'✓ Klient vytvořen: {client.name}')
        )
        ...
        self.stdout.write(
            self.style.SUCCESS(f'✓ Projekt vytvořen: {project.name}')
        )
