...
class RaceConditionTests(TestCase):
    ...
    def test_concurrent_registration_same_email_raises_integrity_error(self):
        ...
        self.assertEqual(user_count, 1, f"Byl vytvořen {user_count} uživatel(é), očekáván 1")
    ...
    def test_concurrent_registration_api_endpoint(self):
        ...
        user_count = User.objects.filter(email=email).count()
        self.assertEqual(
            user_count, 1, f"Skrz API byl vytvořen {user_count} uživatel(é), očekáván 1"
        )
...
class RefreshTokenExpirationTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(email="refresh@example.com", password="testpass123")
...
class TokenBlacklistTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(email="blacklist@example.com", password="testpass123")
    ...
    def test_double_logout_attempt(self):
        ...
        User.objects.create_user(email="double_logout@example.com", password="testpass123")
        ...
        self.assertIn(
            response2.status_code, [status.HTTP_400_BAD_REQUEST, status.HTTP_401_UNAUTHORIZED]
        )
